...
import { FaBed, FaBath, FaRulerCombined, FaMapMarkerAlt, FaMoneyBill } from 'react-icons/fa';
...
const FeaturedPropertyCard = ({ property }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md relative flex flex-col md:flex-row">
      <Image  src={ property.images[0] } alt="Property Image" className="h-auto rounded-t-xl md:rounded-tr-none md:rounded-l-xl w-full md:w-2/5" width={0} height={0} sizes="100vw" />
      <div className="p-6">
